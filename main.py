...
outputtext = tkinter.Message(root,cursor='hand2')
button = tkinter.Button(root, text="Summarize", bg="#bf1d1d", fg="white", font=("Arial", 20), bd=0, padx=10, pady=10, activebackground="#1da1bf",command=lambda:makeSmall())
inputtext.pack()
